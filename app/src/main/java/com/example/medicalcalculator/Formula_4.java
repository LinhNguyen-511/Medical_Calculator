...
public class Formula_4 extends MainActivity {
    MathJaxView mathJaxWebView;
    String tex = "$$Calculated osmolarity = {2 * Na^+ + Ureum + Glucose}$$";
    Toolbar toolbar;
...
//        inflater.inflate(R.layout.formula1, null);
    ...
    public void calculate() {
        ...
        final EditText SUIn = (EditText) findViewById(R.id.UreIn);
